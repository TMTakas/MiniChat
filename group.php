...
<?php
$whatPage = "Chatter en groupe";
include_once "head/head.php";
if($group["is_global"] == "0" && !checkUserPermToGroup($groupId,$username))
{
    header("Location: /MiniChat/group.php");
    die();
}
?>
    ...
    $(document).ready(function(){
        ...
        $( "#button_send" ).click(function() {
            ...
            $.ajax({
                ...
                data: {message: message, group_id: group_id, username_id: username_id, chatWith_id:-1 },
                cache: false,
        ...
        function GetMessages() {
            ...
            xmlhttp.open("GET","ajax_get_messages.php?id_group=" + group_id + "&last_id=" + last_message + "&username_id=" + username_id + "&chatWith_id=-1",true);
            xmlhttp.send();
        }
